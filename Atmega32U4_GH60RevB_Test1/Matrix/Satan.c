...
uint8_t hexaKeys0[ROWS][COLS] = {
	...
	{KEY_LEFT_SHIFT,KEY_Z,KEY_X,KEY_C,KEY_V,KEY_B,KEY_N,KEY_M,KEY_COMMA,KEY_PERIOD,KEY_SLASH,0x00,0x00,KEY_RIGHT_SHIFT},
	{KEY_LEFT_CTRL,KEY_FN,KEY_LEFT_ALT,0x00,0x00,0x00,KEY_SPACE,0x00,0x00,0x00,KEY_RIGHT_ALT,KEY_FN,KEY_FN, KEY_RIGHT_CTRL}
};
uint8_t hexaKeys1[ROWS][COLS] = {
	...
	{KEY_LEFT_SHIFT,KEY_NUM_LOCK,KEY_SCROLL_LOCK,KEY_INSERT,KEY_PRINTSCREEN,MACRO0,MACRO1,MACRO3,AUDIO_VOL_DOWN,AUDIO_VOL_UP,AUDIO_MUTE,0x00,0x00,KEY_RIGHT_SHIFT},
	{KEY_LEFT_CTRL,KEY_FN,KEY_LEFT_ALT,0x00,0x00,0x00,KEY_SPACE,0x00,0x00,0x00,KEY_RIGHT_ALT,KEY_FN,KEY_FN,KEY_RIGHT_CTRL}
};
...
uint8_t keymask[ROWS][COLS] = {
	...
	{0x22,0x11,0x11,0x11,0x11,0x17,0x17,0x17,0x15,0x15,0x15,0x00,0x00,0x22},
	{0x22,0x66,0x22,0x00,0x00,0x00,0x11,0x00,0x00,0x00,0x22,0x66,0x66,0x22}
};
void init_cols(){
	for ( i=0; i<COLS; i++){
